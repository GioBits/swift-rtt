        ...
        <li key={step.id} className="mb-10 ms-6">
          ...
          <span
            className={`absolute flex items-center justify-center w-8 h-8 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 ${
              step.id <= currentStep
                ? step.id === 1
                  ? "bg-cerulean dark:bg-cerulean" // Color para el paso 1
                  : "bg-green-200 dark:bg-green-900" // Color para los demás pasos
          ...
          <h3
            className={`font-medium leading-tight ${
              step.id <= currentStep
                ? step.id === 1
                  ? "text-blueMetal dark:blueMetal" // Color para el paso 1
                  : "text-cerulean dark:text-cerulean" // Color para los demás pasos
                : ""
            }`}
          >
            {step.label}
